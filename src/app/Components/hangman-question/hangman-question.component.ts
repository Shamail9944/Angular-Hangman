...
export class HangmanQuestionComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (
      guessesCurrentValue && guessesCurrentValue.length && guessesCurrentValue != changes['guesses'].previousValue) {
    ...
    // console.log('saving letters from question in characters object = ', this.characters);
  }
